...
- [obreitwi/toolbox](https://github.com/obreitwi/toolbox) - All configuration files and helper scripts combined in a single repository for easier management. (4 weeks ago)
...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v2.41.8](https://github.com/freiheit-com/kuberpult/releases/tag/v2.41.8), 1 day ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.23.0](https://github.com/ast-grep/ast-grep/releases/tag/0.23.0), 1 week ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [tparse: init at 0.13.3](https://github.com/NixOS/nixpkgs/pull/320878) on [NixOS/nixpkgs](https://github.com/NixOS/nixpkgs) (4 days ago)
...
- [bjoernmichaelsen/ghdepup](https://github.com/bjoernmichaelsen/ghdepup) - A minimal tool to update dependencies based on tags published on github that is easy to integrate in any kind of toolchain. (4 days ago)
