...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.22.0](https://github.com/ast-grep/ast-grep/releases/tag/0.22.0), 3 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v2.31.0](https://github.com/freiheit-com/kuberpult/releases/tag/v2.31.0), 3 days ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
...
- [feat: add direnv-support via nix](https://github.com/obreitwi/asfa/pull/26) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (4 days ago)
