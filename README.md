...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.19.2](https://github.com/ast-grep/ast-grep/releases/tag/0.19.2), 2 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v1.24.0](https://github.com/freiheit-com/kuberpult/releases/tag/v1.24.0), 4 days ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
...
- [fix: dropdowns not closing when clicking outside](https://github.com/freiheit-com/kuberpult/pull/1363) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (4 days ago)
- [chore(fmt): run cargo fmt](https://github.com/obreitwi/asfa/pull/23) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (5 days ago)
- [chore(deps): remove atty](https://github.com/obreitwi/asfa/pull/22) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (5 days ago)
