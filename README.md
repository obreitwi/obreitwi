...
- [theZiz/aha](https://github.com/theZiz/aha) - Ansi HTML Adapter (3 days ago)
- [strang1ato/nhi](https://github.com/strang1ato/nhi) - :tv: Automatically capture all potentially useful information about each executed command (as well as its output) and get powerful querying mechanism (4 days ago)
