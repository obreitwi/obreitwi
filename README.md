...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v8.8.0](https://github.com/freiheit-com/kuberpult/releases/tag/v8.8.0), 2 days ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
...
- [maralorn/nix-output-monitor](https://github.com/maralorn/nix-output-monitor) - Pipe your nix-build output through the nix-output-monitor a.k.a nom to get additional information while building. (4 weeks ago)
