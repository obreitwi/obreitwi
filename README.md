...
- [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ([v8.0.1](https://github.com/nvim-neorg/neorg/releases/tag/v8.0.1), today) - Modernity meets insane extensibility. The future of organizing your life in Neovim.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.20.0](https://github.com/ast-grep/ast-grep/releases/tag/0.20.0), today) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v2.13.0](https://github.com/freiheit-com/kuberpult/releases/tag/v2.13.0), 3 days ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
...
- [fix: errors &#34;was not wrapped in act(...)&#34;](https://github.com/freiheit-com/kuberpult/pull/1465) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (2 days ago)
- [feat: implement endpoint to retrieve manifests](https://github.com/freiheit-com/kuberpult/pull/1453) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (4 days ago)
- [feat: remove MDCTextfield from lock message](https://github.com/freiheit-com/kuberpult/pull/1452) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (4 days ago)
- [feat: remove use of MDCTextField in top bar](https://github.com/freiheit-com/kuberpult/pull/1448) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (5 days ago)
- [feat: supply args to &#39;go test&#39; via GO_TEST_ARGS](https://github.com/freiheit-com/kuberpult/pull/1440) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (6 days ago)
...
- [NixOS/nix.dev](https://github.com/NixOS/nix.dev) - Official documentation for getting things done with Nix. (1 month ago)
