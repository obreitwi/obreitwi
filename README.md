...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.22.0](https://github.com/ast-grep/ast-grep/releases/tag/0.22.0), 4 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [feat: add direnv-support via nix](https://github.com/obreitwi/asfa/pull/26) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (5 days ago)
