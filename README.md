...
- [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ([v6.2.0](https://github.com/nvim-neorg/neorg/releases/tag/v6.2.0), 1 day ago) - Modernity meets insane extensibility. The future of organizing your life in Neovim.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.13.1](https://github.com/ast-grep/ast-grep/releases/tag/0.13.1), 4 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [update dependencies](https://github.com/obreitwi/asfa/pull/21) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (5 days ago)
