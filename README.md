...
- [obreitwi/advent-of-code-2023-haskell](https://github.com/obreitwi/advent-of-code-2023-haskell) - Solutions from Advent of Code in 2023 to get back into Haskell a bit. (1 month ago)
- [DataDog/dd-sdk-go-testing](https://github.com/DataDog/dd-sdk-go-testing) - Datadog Test Instrumentation framework for Go (3 months ago)
...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.19.3](https://github.com/ast-grep/ast-grep/releases/tag/0.19.3), 1 day ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v1.24.0](https://github.com/freiheit-com/kuberpult/releases/tag/v1.24.0), 5 days ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
...
- [fix: dropdowns not closing when clicking outside](https://github.com/freiheit-com/kuberpult/pull/1363) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (5 days ago)
- [chore(fmt): run cargo fmt](https://github.com/obreitwi/asfa/pull/23) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (6 days ago)
- [chore(deps): remove atty](https://github.com/obreitwi/asfa/pull/22) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (6 days ago)
- [feat: add feature toggle for writing commit data](https://github.com/freiheit-com/kuberpult/pull/1332) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (2 weeks ago)
...
- [preiter93/wireman](https://github.com/preiter93/wireman) - A TUI gRPC client (1 week ago)
- [beneater/msbasic](https://github.com/beneater/msbasic) - Microsoft BASIC for 6502 (Commodore, Apple, KIM-1, AIM-65, OSI, ...) (2 weeks ago)
...
- [ManimCommunity/manim](https://github.com/ManimCommunity/manim) - A community-maintained Python framework for creating mathematical animations.  (2 months ago)
