...
- [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ([v5.0.0](https://github.com/nvim-neorg/neorg/releases/tag/v5.0.0), 3 days ago) - Modernity meets insane extensibility. The future of organizing your life in Neovim.
...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) - ⚡A fast and polyglot tool for code structrual search, lint and rewriting at large scale. Written in Rust (4 weeks ago)
