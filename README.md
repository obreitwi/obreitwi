...
- [obreitwi/asfa](https://github.com/obreitwi/asfa) - Avoid sending file attachments by uploading them via SSH to a remote site and sharing a publicly-accessible URL with non-guessable (hash-based) prefix instead. (2 weeks ago)
...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.23.1](https://github.com/ast-grep/ast-grep/releases/tag/0.23.1), 1 day ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v2.41.8](https://github.com/freiheit-com/kuberpult/releases/tag/v2.41.8), 2 days ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
...
- [tparse: init at 0.13.3](https://github.com/NixOS/nixpkgs/pull/320878) on [NixOS/nixpkgs](https://github.com/NixOS/nixpkgs) (5 days ago)
...
- [bjoernmichaelsen/ghdepup](https://github.com/bjoernmichaelsen/ghdepup) - A minimal tool to update dependencies based on tags published on github that is easy to integrate in any kind of toolchain. (5 days ago)
