...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v10.1.0](https://github.com/freiheit-com/kuberpult/releases/tag/v10.1.0), 1 day ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
...
- [fix: build with go 1.23 by tracking modules.txt](https://github.com/nix-community/gomod2nix/pull/168) on [nix-community/gomod2nix](https://github.com/nix-community/gomod2nix) (3 weeks ago)
...
- [maralorn/nix-output-monitor](https://github.com/maralorn/nix-output-monitor) - Pipe your nix-build output through the nix-output-monitor a.k.a nom to get additional information while building. (1 month ago)
