...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.13.0](https://github.com/ast-grep/ast-grep/releases/tag/0.13.0), 4 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [fix: filter sensitive information from git-retrieved repository URL](https://github.com/DataDog/dd-sdk-go-testing/pull/27) on [DataDog/dd-sdk-go-testing](https://github.com/DataDog/dd-sdk-go-testing) (1 day ago)
