...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v7.7.0](https://github.com/freiheit-com/kuberpult/releases/tag/v7.7.0), 1 day ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.26.0](https://github.com/ast-grep/ast-grep/releases/tag/0.26.0), 1 day ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [fix: handle dots in username/hostname](https://github.com/viperML/nh/pull/140) on [viperML/nh](https://github.com/viperML/nh) (4 days ago)
