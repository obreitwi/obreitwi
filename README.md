...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) - ⚡A CLI tool for code structrual search, lint and rewriting. Written in Rust (3 days ago)
...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.11.0](https://github.com/ast-grep/ast-grep/releases/tag/0.11.0), 3 days ago) - ⚡A CLI tool for code structrual search, lint and rewriting. Written in Rust
...
- [feat: Rename scan --rule-id → scan --filter](https://github.com/ast-grep/ast-grep/pull/596) on [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) (4 days ago)
- [feat: add option `scan --rule-id &lt;rule_id&gt;…`](https://github.com/ast-grep/ast-grep/pull/594) on [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) (5 days ago)
...
- [keyboardio/Kaleidoscope](https://github.com/keyboardio/Kaleidoscope) - Firmware for Keyboardio keyboards and other keyboards with AVR or ARM MCUs. (2 days ago)
