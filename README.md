...
- [obreitwi/asfa](https://github.com/obreitwi/asfa) - Avoid sending file attachments by uploading them via SSH to a remote site and sharing a publicly-accessible URL with non-guessable (hash-based) prefix instead. (4 months ago)
...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v10.1.5](https://github.com/freiheit-com/kuberpult/releases/tag/v10.1.5), 1 day ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
