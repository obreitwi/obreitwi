...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.12.0](https://github.com/ast-grep/ast-grep/releases/tag/0.12.0), today) - ⚡A CLI tool for code structrual search, lint and rewriting. Written in Rust
