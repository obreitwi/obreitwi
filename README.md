...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.26.1](https://github.com/ast-grep/ast-grep/releases/tag/0.26.1), 5 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [tfautomv: 0.5.4 -&gt; 0.6.2](https://github.com/NixOS/nixpkgs/pull/334475) on [NixOS/nixpkgs](https://github.com/NixOS/nixpkgs) (1 day ago)
