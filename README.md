...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v1.22.1](https://github.com/freiheit-com/kuberpult/releases/tag/v1.22.1), 3 days ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.19.0](https://github.com/ast-grep/ast-grep/releases/tag/0.19.0), 3 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [feat: add feature toggle for writing commit data](https://github.com/freiheit-com/kuberpult/pull/1332) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (6 days ago)
...
- [feat: Rename scan --rule-id → scan --filter](https://github.com/ast-grep/ast-grep/pull/596) on [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) (6 months ago)
- [feat: add option `scan --rule-id &lt;rule_id&gt;…`](https://github.com/ast-grep/ast-grep/pull/594) on [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) (6 months ago)

#### ⭐ Recent Stars

- [preiter93/wireman](https://github.com/preiter93/wireman) - A TUI based gRPC client (2 days ago)
- [beneater/msbasic](https://github.com/beneater/msbasic) - Microsoft BASIC for 6502 (Commodore, Apple, KIM-1, AIM-65, OSI, ...) (6 days ago)
...
- [fullstorydev/grpcurl](https://github.com/fullstorydev/grpcurl) - Like cURL, but for gRPC: Command-line tool for interacting with gRPC servers (2 months ago)
