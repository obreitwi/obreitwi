...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v2.1.0](https://github.com/freiheit-com/kuberpult/releases/tag/v2.1.0), 1 day ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.19.3](https://github.com/ast-grep/ast-grep/releases/tag/0.19.3), 4 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [fix: dropdowns not closing when clicking outside](https://github.com/freiheit-com/kuberpult/pull/1363) on [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) (1 week ago)
