...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v2.31.1](https://github.com/freiheit-com/kuberpult/releases/tag/v2.31.1), 1 day ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.22.3](https://github.com/ast-grep/ast-grep/releases/tag/0.22.3), 1 day ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [nix-community/noogle](https://github.com/nix-community/noogle) - https://noogle.dev - nix function exploring. [maintainer=@hsjobeki]  (1 day ago)
