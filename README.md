...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.16.0](https://github.com/ast-grep/ast-grep/releases/tag/0.16.0), 2 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
- [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ([v7.0.0](https://github.com/nvim-neorg/neorg/releases/tag/v7.0.0), 3 days ago) - Modernity meets insane extensibility. The future of organizing your life in Neovim.
