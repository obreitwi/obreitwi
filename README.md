...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.16.1](https://github.com/ast-grep/ast-grep/releases/tag/0.16.1), 4 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
