...
- [obreitwi/neorg-task-sync](https://github.com/obreitwi/neorg-task-sync) - Sync TODOs from Neorg Journal with Google Tasks (3 days ago)
...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v5.0.0](https://github.com/freiheit-com/kuberpult/releases/tag/v5.0.0), 1 day ago) - Kuberpult helps you manage different versions of different microservices in different cluster.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.25.2](https://github.com/ast-grep/ast-grep/releases/tag/0.25.2), 4 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [nix-community/nix-direnv](https://github.com/nix-community/nix-direnv) - A fast, persistent use_nix/use_flake implementation for direnv [maintainer=@Mic92 / @bbenne10]  (3 weeks ago)
