...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.16.1](https://github.com/ast-grep/ast-grep/releases/tag/0.16.1), 3 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [fullstorydev/grpcurl](https://github.com/fullstorydev/grpcurl) - Like cURL, but for gRPC: Command-line tool for interacting with gRPC servers (2 weeks ago)
