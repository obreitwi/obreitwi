...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.26.1](https://github.com/ast-grep/ast-grep/releases/tag/0.26.1), 1 day ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [fix: handle dots in username/hostname](https://github.com/viperML/nh/pull/140) on [viperML/nh](https://github.com/viperML/nh) (5 days ago)
