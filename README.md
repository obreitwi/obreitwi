...
- [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ([v6.0.0](https://github.com/nvim-neorg/neorg/releases/tag/v6.0.0), 3 days ago) - Modernity meets insane extensibility. The future of organizing your life in Neovim.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.12.1](https://github.com/ast-grep/ast-grep/releases/tag/0.12.1), 1 week ago) - ⚡A CLI tool for code structrual search, lint and rewriting. Written in Rust
