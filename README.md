...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.18.1](https://github.com/ast-grep/ast-grep/releases/tag/0.18.1), 1 day ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
