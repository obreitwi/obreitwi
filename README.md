...
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.15.1](https://github.com/ast-grep/ast-grep/releases/tag/0.15.1), 6 days ago) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [SteamDeckHomebrew/decky-loader](https://github.com/SteamDeckHomebrew/decky-loader) - A plugin loader for the Steam Deck. (1 day ago)
