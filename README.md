...
- [freiheit-com/kuberpult](https://github.com/freiheit-com/kuberpult) ([v2.31.1](https://github.com/freiheit-com/kuberpult/releases/tag/v2.31.1), today) - Kuberpult helps you manage different versions of different microservices in different cluster.
- [ast-grep/ast-grep](https://github.com/ast-grep/ast-grep) ([0.22.3](https://github.com/ast-grep/ast-grep/releases/tag/0.22.3), today) - ⚡A CLI tool for code structural search, lint and rewriting. Written in Rust
...
- [feat: add direnv-support via nix](https://github.com/obreitwi/asfa/pull/26) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (6 days ago)
- [feat: add preliminary nix-support via crane](https://github.com/obreitwi/asfa/pull/25) on [obreitwi/asfa](https://github.com/obreitwi/asfa) (2 weeks ago)
...
- [nix-community/noogle](https://github.com/nix-community/noogle) - https://noogle.dev - nix function exploring. [maintainer=@hsjobeki]  (today)
...
- [mipmip/home-manager-option-search](https://github.com/mipmip/home-manager-option-search) - Home Manager Option Search (3 weeks ago)
